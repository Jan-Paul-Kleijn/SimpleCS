var artistry = {
  ...
  stackBlurCanvasRGBA:function(id, top_x, top_y, width, height, radius) {
    ...
    var pixels = imageData.data, x, y, i, p, yp, yi, yw, r_sum, g_sum, b_sum, a_sum, r_out_sum,
        g_out_sum, b_out_sum, a_out_sum, r_in_sum, g_in_sum, b_in_sum, a_in_sum, pr, pg, pb, pa, rbs,
        div = radius + radius + 1,
        w4 = width << 2,
        widthMinus1 = width - 1,
  ...
  stackBlurCanvasRGB:function(id, top_x, top_y, width, height, radius) {
    ...
    var pixels = imageData.data, x, y, i, p, yp, yi, yw, r_sum, g_sum, b_sum, r_out_sum,
        g_out_sum, b_out_sum, r_in_sum, g_in_sum, b_in_sum, pr, pg, pb, rbs,
        div = radius + radius + 1,
        w4 = width << 2,
        widthMinus1 = width - 1,
        heightMinus1 = height - 1,
